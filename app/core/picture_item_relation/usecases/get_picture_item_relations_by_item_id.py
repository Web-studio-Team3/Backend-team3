...
class GetPictureItemRelationsByItemIdUseCase(
    UseCase[PictureItemRelationItemId, list[PictureItemRelation]]
):
    ...
    def execute(self, obj: PictureItemRelationItemId) -> list[PictureItemRelation]:
        ...
        item_relations = filter(
            lambda relation: relation.item_id == obj.item_id, relations
        )
