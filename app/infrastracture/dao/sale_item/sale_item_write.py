...
class SaleItemRelationWriteImpl(BaseDao, SaleItemRelationWrite):
    def create(self, sale_item_relation: SaleItemRelation) -> SaleItemRelation:
        inserted_id = (
            self._database["sale_item_relation"]
            .insert_one(
    ...
    def deleteByItemId(self, item_id: str) -> None:
        self._database["sale_item_relation"].delete_one({"item_id": item_id})
