...
from app.core.picture_item_relation.dao.picture_item_relation_write import PictureItemRelationWrite
...
class PictureItemRelationWriteImpl(
    BaseDao, PictureItemRelationWrite
):
    def create(self, picture_item_relation: PictureItemRelation) -> PictureItemRelation:
        picture_item_relation_id = self._database["picture_item_relation"].insert_one(
    ...
    def delete(self, id: str) -> None:
        self._database["picture_item_relation"].delete_one(
            {"_id": ObjectId(id)})
