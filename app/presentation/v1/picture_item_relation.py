...
async def create(
    ...
    picture_item_relation_create_use_case: CreatePictureItemRelationUseCase = Depends(
        provide_create_picture_item_relation_stub
    ),
...
async def get(
    ...
    get_picture_item_relation_use_case: GetPictureItemRelationByIdUseCase = Depends(
        provide_get_picture_item_relation_by_id_stub
    ),
):
...
async def get_by_item_id(
    item_id: str,
    get_picuture_item_relations_by_item_id_use_case: GetPictureItemRelationsByItemIdUseCase = Depends(
        provide_get_picture_item_relations_by_item_id_stub
    ),
):
...
async def update(
    picture_item_relation: PictureItemRelation,
    picture_item_relation_update_use_case: UpdatePictureItemRelationUseCase = Depends(
        provide_update_picture_item_relation_stub
    ),
    jwt: str = Depends(JWTBearer()),
    get_access_token_by_jwt_use_case: GetAccessTokenByJwtUseCase = Depends(
...
async def delete(
    picture_item_relation_id: str,
    delete_picture_item_relation_use_case: DeletePictureItemRelationUseCase = Depends(
        provide_delete_picture_item_relation_stub
    ),
    jwt: str = Depends(JWTBearer()),
    get_access_token_by_jwt_use_case: GetAccessTokenByJwtUseCase = Depends(
    ...
    get_picture_item_realtion_use_case: GetPictureItemRelationByIdUseCase = Depends(
        provide_get_picture_item_relation_by_id_stub
    ),
):
    ...
    return {"chat_message": "picture_item_relation was deleted"}
